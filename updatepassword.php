    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 ">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h3 class="title text-center" id="heading-k">Update password</h3> <br>
                    <form action="updatepassword.php" method="post">
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                <label for="name"><b>
                                        <h7> Enter new password:</h7>
                                    </b></label>
                                <input type="password" id="name" name="newpassword" class="form-control "
                         ...
                         <br>
                             ...
                             <center>
                            <input class="btn bg-gra-02 text-white" type="submit" id="submit" name="submitnewpassword" value="Update">
                            </center>
...
if(isset($_POST['submitnewpassword'])){
    ...
    $query = "UPDATE signup set Password = '$Password' WHERE Email= '".$_SESSION['EMAIL']."'"; 
