    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        ...
        <?php
            ...
            $Role = $_SESSION['ROLE'];
            $query = "select * from delivery where EmailRes='$Email'";
            ...
            $query2 = "select * from food_requests where rno='".$row['rno']."'";
            $result2 = mysqli_query($connection,$query2);
            if(!$result2){
                die("Query Failed 3".mysqli_error());
            }
            ...
            if($pincode_res === $pincode_org && $status == 'accepted'){  
               $RNO = $row['rno'];
             $count=$count+1; 
        ?>
          <!-- list group item-->
          <li id="cards"  class="list-group-item">
            ...
            <div class="media align-items-lg-center flex-column flex-lg-row p-3">
              ...
              <h7 class="font-weight-bold my-2"><?php echo "Request #".$row['rno']."-".$Name; ?></h7>
              <div class="float-lg-right">
                <button id="<?php echo $RNO; ?>" class="btn btn-outline-light my-2 my-sm-0" onclick="window.location='resstatus.php?rno=<?php echo $row['rno'] ?>'" name="status" type="Logout">View/Modify Status</button>
                </div>
