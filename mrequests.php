    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        ...
        <?php
            ...
            if($pincode_res === $pincode_org && $row['status'] == 'accepted' ){  
               $RNO = $row['rno'];
        ...
        ?>
          ...
          <li id="cards"  class="list-group-item">
            ...
            <div class="media align-items-lg-center flex-column flex-lg-row p-3">
              ...
              <h7 class="font-weight-bold my-2"><?php echo "Request #".$row['rno']."-".$row['Subject']."-".$Name; ?></h7>
              <div class="float-lg-right">
                <button id="<?php echo $RNO; ?>" class="btn btn-outline-light my-2 my-sm-0"  name="status" type="Logout">View/Modify Status</button>
                </div>
            ...
            <br>
                <?php
                 ...
                 elseif($Role == "Organisation"){
                  $Emailorg = $row['Email'];
                  $Rn = $row['rno'];
                  if($Email === $Emailorg && $row['status'] != 'withdrawn'){
                            $count=$count+1;
                ?>
          ...
          <li id="cards" class="list-group-item">
            ...
            <div class="media align-items-lg-center flex-column flex-lg-row p-3">
              <div class="media-body order-2 order-lg-1">
              <h7 class="font-weight-bold my-2"><?php echo "Request #".$row['rno']."-".$row['Subject']; ?></h7> 
              
              <div class="float-lg-right">
                <button id="withdraw" class="btn btn-outline-light my-2 my-sm-0" onclick="window.location='orgstatus.php?rno=<?php echo $row['rno'] ?>'" name="status" type="Logout">View/Modify Status</button>
                
                <button  class="btn btn-outline-light my-2 my-sm-0" onclick="window.location='requestwithdraw.php?rno=<?php echo $Rn?>'" name="withdraw" type="Logout">Withdraw</button>
                </div>  
              <div class="d-flex align-items-center justify-content-between mt-1">
