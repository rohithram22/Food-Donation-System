    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 ">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h3 class="title text-center" id="heading-k">Update Location</h3> <br>
                    <form action="updatelocation.php" method="post">
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                ...
                                <input type="test" id="name" name="address" class="form-control "
                                    placeholder="" value="<?php echo $Address?>" required>
                            </div>
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                ...
                                <input type="text" id="name" name="city" class="form-control "
                                    placeholder="" value="<?php echo $City?>" required>
                            </div>
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                ...
                                <input type="text" id="name" name="pincode" class="form-control "
                                    placeholder="" value="<?php echo $Pincode?>" required>
                            </div>
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                ...
                                <input type="text" id="name" name="state" class="form-control "
                                    placeholder="" value="<?php echo $State?>" required>
                            </div>
                         ...
                         <br>
                             ...
                             <center>
                            <input class="btn bg-gra-02 text-white" type="submit" id="submit" name="submitnewlocation" value="Update">
                            </center>
...
<?php
extract($_POST);
if(isset($_POST['submitnewlocation'])){
    $address = $_POST['address'];
    $city = $_POST['city'];
    $pincode = $_POST['pincode'];
    $state = $_POST['state'];
    $query = "UPDATE signup set Address = '$address', City = '$city', Pincode = '$pincode', State = '$state' WHERE Email= '".$_SESSION['EMAIL']."'"; 
    $result = mysqli_query($connection, $query);
    if(!$result){
       //echo "yes"; 
       die();
