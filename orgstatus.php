            ...
            <div class="card card-4">
                <div class="card-body">
                    <h3 class="title text-center" id="heading-k">Food Delivery</h3> <br>
                        ...
                        ?>    
                        <center>
                        <button id="<?php echo $RNO; ?>" class="btn btn-outline-light my-2 my-sm-0" onclick="window.location='setdelivered.php?rno=<?php echo $RNO ?>'" name="accept" type="Logout">Food Delivered</button>
                        </center>
                        <?php } ?>
